...
export class ClientUpdate extends React.Component<IClientUpdateProps, IClientUpdateState> {
  ...
  render() {
    const { clientEntity, organizationsDetails, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rpaedatablockApp.client.home.createOrEditLabel">Create or edit a Client</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : clientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="clientContactEmailAddressLabel" for="clientContactEmailAddress">
                    Client Contact Email Address
                  </Label>
                  <AvField id="client-clientContactEmailAddress" type="text" name="clientContactEmailAddress" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label for="organizationsdetails.id">Organizationsdetails</Label>
                  <AvInput id="client-organizationsdetails" type="select" className="form-control" name="organizationsdetailsId">
                    <option value="" key="0" />
