      ...
      <div>
        <h2 id="email-processing-error-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Email Processing Error
          </Link>
        </h2>
            ...
            <tbody>
              {emailProcessingErrorList.map((emailProcessingError, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {emailProcessingError.emailProcessingId ? (
                      <Link to={`email-processing/${emailProcessingError.emailProcessingId}`}>
                        {emailProcessingError.emailProcessingId}
                      </Link>
                    ) : (
                      ''
