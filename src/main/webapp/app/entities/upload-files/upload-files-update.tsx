    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rpaedatablockApp.uploadFiles.home.createOrEditLabel">Create or edit a UploadFiles</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : uploadFilesEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="upload-files-fileName" type="text" name="fileName" />
                </AvGroup>
                <AvGroup>
                  <Label id="fileExtensionLabel" for="fileExtension">
                    File Extension
                  </Label>
                  <AvField id="upload-files-fileExtension" type="text" name="fileExtension" />
                </AvGroup>
                <AvGroup>
