...
public class UploadFilesResource {
    ...
    @Timed
    public ResponseEntity<UploadFilesDTO> createUploadFiles(@RequestBody UploadFilesDTO uploadFilesDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<UploadFilesDTO> updateUploadFiles(@RequestBody UploadFilesDTO uploadFilesDTO) throws URISyntaxException {
