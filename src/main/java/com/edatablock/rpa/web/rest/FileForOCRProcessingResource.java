...
public class FileForOCRProcessingResource {
    ...
    @Timed
    public ResponseEntity<FileForOCRProcessingDTO> createFileForOCRProcessing(@RequestBody FileForOCRProcessingDTO fileForOCRProcessingDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<FileForOCRProcessingDTO> updateFileForOCRProcessing(@RequestBody FileForOCRProcessingDTO fileForOCRProcessingDTO) throws URISyntaxException {
