...
public class EmailAttachmentResource {
    ...
    @Timed
    public ResponseEntity<EmailAttachmentDTO> createEmailAttachment(@RequestBody EmailAttachmentDTO emailAttachmentDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<EmailAttachmentDTO> updateEmailAttachment(@RequestBody EmailAttachmentDTO emailAttachmentDTO) throws URISyntaxException {
