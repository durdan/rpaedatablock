...
public class TemplateFieldsResource {
    ...
    @Timed
    public ResponseEntity<TemplateFieldsDTO> createTemplateFields(@RequestBody TemplateFieldsDTO templateFieldsDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<TemplateFieldsDTO> updateTemplateFields(@RequestBody TemplateFieldsDTO templateFieldsDTO) throws URISyntaxException {
