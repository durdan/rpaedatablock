...
public class EmailProcessingErrorResource {
    ...
    @Timed
    public ResponseEntity<EmailProcessingErrorDTO> createEmailProcessingError(@RequestBody EmailProcessingErrorDTO emailProcessingErrorDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<EmailProcessingErrorDTO> updateEmailProcessingError(@RequestBody EmailProcessingErrorDTO emailProcessingErrorDTO) throws URISyntaxException {
