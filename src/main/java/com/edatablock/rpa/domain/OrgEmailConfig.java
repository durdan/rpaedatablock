...
public class OrgEmailConfig implements Serializable {
    ...
    private OrganizationsDetails client;
    ...
    public OrganizationsDetails getClient() {
        return client;
    }

    public OrgEmailConfig client(OrganizationsDetails organizationsDetails) {
        this.client = organizationsDetails;
        return this;
    }

    public void setClient(OrganizationsDetails organizationsDetails) {
        this.client = organizationsDetails;
    }
